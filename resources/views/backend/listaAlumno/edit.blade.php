            ...
            <div class="sparkline16-list">
                <div class="sparkline16-hd">
                    ...
                    <div class="main-sparkline13-hd">
                        ...
                        <h1>{{$listaAlumno->count()}} Alumnos</h1>
                    </div>
                </div>
                <div class="sparkline16-graph">
                    ...
                    @endif
                    <form action="{{route('listaAlumnoUpdate', $listaAlumno->id)}}" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                        {{csrf_field()}}
                        <div class="row">
                        <div class="col-md-12 ">
                            <label>Alumno:</label><p>{{$listaAlumno->name}} {{$listaAlumno->last_name}}</p>
                            <input type="hidden" name="alumno_id" value="{{$listaAlumno->user_id}}">
                        </div>
                        <div class="col-md-12 ">
                                <input type="hidden" name="salon_id" value="{{$listaAlumno->salon_id}}">
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/listaAlumnoEdit.css')}}">
@endpush
