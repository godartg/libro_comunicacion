        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="sparkline16-list">
                ...
                <div class="sparkline16-graph">
                    ...
                    @endif
                    <form action="{{route('materialStore')}}" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <input type="hidden" name="curso_id" class="form-control" placeholder="ID Curso" disabled="disabled" value="{{$curso->id}}">
                                    <input type="hidden" name="docente_id" class="form-control" placeholder="ID Docente" disabled="disabled" value="{{Auth::user()->id}}">
