            ...
            <div class="sparkline16-list">
                ...
                <div class="sparkline16-graph">
                    ...
                    <div class="review-content-section">
                      ...
                      <form action="{{route('evaluacionStore')}}" method="POST" class="dropzone dropzone-custom needsclick add-professors dz-clickable" id="demo1-upload" >
                        {{csrf_field()}}
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="evaluacion_titulo" class="form-control" placeholder="Título de evaluación">
                            </div>

                            <div class="form-group">
                              <label for="evaluacion_fecha">Fecha de evaluación:</label>
                              <input type="date" name="evaluacion_fecha" class="form-control" placeholder="Fecha">
                            </div>
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                              ...
                              <textarea name="evaluacion_detalle" placeholder="Escribir el detalle de la evaluación"></textarea>
                            </div>
                            <div class="form-group">
